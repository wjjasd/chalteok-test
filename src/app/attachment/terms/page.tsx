    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-sky-50 to-white">
      <div className="flex-1 flex flex-col items-center px-4 py-8">
        <div className="w-full max-w-lg">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900">면책 고지 및 약관 동의</h1>
            <p className="mt-1 text-sm text-gray-500">테스트 시작 전 아래 내용을 확인해 주세요.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-6 text-sm text-gray-700 leading-relaxed space-y-4 max-h-80 overflow-y-auto">
            ...
            <ol className="list-decimal pl-4 space-y-3 text-gray-600">
              ...
              <li>
                결과를 근거로 자신이나 상대방의 성격을 단정짓는 용도로 사용하는 것은 <strong>권장하지 않습니다</strong>. 중요한 관계 문제에 대해서는 반드시 전문 상담사 또는 심리 전문가의 도움을 받으시기 바랍니다.
              </li>
              <li>
                본 점수 체계는 완전하지 않으며, 인간 관계의 복잡성을 하나의 유형으로 환원할 수 없습니다. 결과를 맹신하지 마십시오.
              </li>
              <li>
          ...
          <div className="space-y-3 mb-8">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="mt-0.5 w-5 h-5 rounded border-gray-300 accent-sky-500 flex-shrink-0"
              />
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl font-semibold transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed bg-sky-500 hover:bg-sky-600 text-white"
          >
            {loading ? (
